...
var Engine = class {
  ...
  load(params) {
    return __async(this, null, function* () {
      const randomFactor = 1e4, id = params.id ?? params.element?.id ?? `tsparticles${Math.floor(getRandom() * randomFactor)}`, { index, url } = params, options = url ? yield getDataFromUrl({ fallback: params.options, url, index }) : params.options;
...
//# sourceMappingURL=chunk-GO3YUYL4.js.map
