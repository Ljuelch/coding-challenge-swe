...
var Absorbers = class {
  constructor(container) {
    ...
    container.addAbsorber = (options, position) => __async(this, null, function* () {
      return this.addAbsorber(options, position);
    });
  }
  ...
  init() {
    return __async(this, null, function* () {
      ...
      const promises = executeOnSingleOrMultiple(this.absorbers, (absorber) => __async(this, null, function* () {
        yield this.addAbsorber(absorber);
      }));
...
function loadAbsorbersPlugin(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addPlugin(new AbsorbersPlugin(), refresh);
  });
}
...
function loadDestroyUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addParticleUpdater("destroy", (container) => {
...
var Emitters = class {
  constructor(engine, container) {
    ...
    container.addEmitter = (options, position) => __async(this, null, function* () {
      return this.addEmitter(options, position);
    });
  ...
  handleClickMode(mode) {
    ...
    void executeOnSingleOrMultiple(emittersOptions, (emitter) => __async(this, null, function* () {
      yield this.addEmitter(emitter, ePosition);
    }));
  }
  init() {
    return __async(this, null, function* () {
      ...
      if (isArray(this.emitters)) {
        for (const emitterOptions of this.emitters) {
          yield this.addEmitter(emitterOptions);
        }
      } else {
        yield this.addEmitter(this.emitters);
      }
    });
  }
  pause() {
...
function loadEmittersPlugin(engine, refresh = true) {
  return __async(this, null, function* () {
...
function loadEmittersShapeCircle(engine, refresh = true) {
  return __async(this, null, function* () {
    const emittersEngine = engine;
    emittersEngine.addEmitterShapeGenerator?.("circle", new EmittersCircleShapeGenerator());
    yield emittersEngine.refresh(refresh);
  });
}
...
function loadEmittersShapeSquare(engine, refresh = true) {
  return __async(this, null, function* () {
    const emittersEngine = engine;
...
function loadExternalTrailInteraction(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addInteractor("externalTrail", (container) => {
...
function loadRollUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addParticleUpdater("roll", () => {
...
function loadTextShape(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addShape(new TextDrawer(), refresh);
  });
}
...
function loadTiltUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addParticleUpdater("tilt", (container) => {
...
function loadTwinkleUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addParticleUpdater("twinkle", () => {
...
function loadWobbleUpdater(engine, refresh = true) {
  return __async(this, null, function* () {
    yield engine.addParticleUpdater("wobble", (container) => {
...
function loadFull(engine, refresh = true) {
  return __async(this, null, function* () {
    yield loadDestroyUpdater(engine, false);
    yield loadRollUpdater(engine, false);
    yield loadTiltUpdater(engine, false);
    yield loadTwinkleUpdater(engine, false);
    yield loadWobbleUpdater(engine, false);
    yield loadTextShape(engine, false);
    yield loadExternalTrailInteraction(engine, false);
    yield loadAbsorbersPlugin(engine, false);
    yield loadEmittersPlugin(engine, false);
    yield loadEmittersShapeCircle(engine, false);
    yield loadEmittersShapeSquare(engine, false);
    yield loadSlim(engine, refresh);
  });
}
export {
  loadFull
